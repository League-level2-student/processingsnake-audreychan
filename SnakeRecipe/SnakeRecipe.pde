...
int foodX = ((int)random(width/10)*10);
int foodY = ((int)random(height/10)*10);
...
void keyPressed() {
  //println(keyCode);
  if(keyCode == 38 && !dir.equals("down")){
    dir = "up";
  }
  if(keyCode == 40 && !dir.equals("up")){
    dir = "down";
  }
  if(keyCode == 37 && !dir.equals("right")){
    dir = "left";
  }
  if(keyCode == 39 && !dir.equals("left")){
    dir = "right";
  }
  if(keyCode == 83){
    speed ++;
